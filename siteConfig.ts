...
export const siteConfig = {
  ...
  // 2. 头像设置 (请将你的头像文件命名为 avatar.jpg 放在 /public/images 文件夹)
  avatarUrl: "/images/optimized/avatar.webp",
  ...
  bgImages: [
    "/images/optimized/bg-1.webp",
    "/images/optimized/bg-2.webp",
    "/images/optimized/bg-3.webp",
    "/images/optimized/bg-4.webp",
    "/images/optimized/bg-5.webp",
    "/images/optimized/bg-6.webp",
    "/images/optimized/bg-7.webp",
    "/images/optimized/bg-8.webp",
    "/images/optimized/bg-9.webp",
    "/images/optimized/bg-10.webp",
  ],

  // 4. 文章默认封面图
  defaultPostCover: "/images/optimized/default-cover.webp",

  // 5. 首页照片墙预览图 (请将你的照片墙预览图命名为 photowall.jpg 放在 /public/images 文件夹)
  photoWallImage: "/images/optimized/photowall.webp",
  ...
  buildDate: "2026-06-17T00:00:00", // 建站日期
  ...
  icpConfig: { name: "鄂ICP备2026025861号", link: "https://beian.miit.gov.cn/" },
  geminiConfig: {
  ...
  friendLinkApplyFormat: "名称：y悠悠の宝藏之地\n简介：今天我也要学习吗\n链接：https://www.ayuu.fun\n头像：https://bu.dusays.com/2026/03/24/69c1e38ac1846.jpg",
