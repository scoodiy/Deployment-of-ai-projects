...
export default function FloatingPlayer() {
  ...
  return (
    <div className="hidden md:block fixed bottom-6 right-6 z-[9999]" style={{ pointerEvents: 'none' }}>
      <motion.div
        drag
      ...
      >
        ...
        <div className="flex items-center gap-2 ml-1">
          <button
            ...
            className="min-w-[44px] min-h-[44px] bg-indigo-500 text-white rounded-full flex items-center justify-center shadow-md hover:scale-110 transition-transform cursor-pointer"
          >
          ...
          <button
            ...
            onPointerDown={(e) => e.stopPropagation()}
            className="min-w-[44px] min-h-[44px] flex items-center justify-center text-slate-600 dark:text-slate-300 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors cursor-pointer"
          >
