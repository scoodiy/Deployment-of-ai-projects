  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <img
          src={siteConfig.avatar_url || '/images/optimized/avatar.webp'}
...
function SocialButton({ label, icon, href, onClick }: SocialButtonProps) {
  const className = 'inline-flex min-w-[44px] min-h-[44px] h-11 w-11 items-center justify-center border border-[var(--home-border)] text-[var(--home-muted)] transition-colors hover:border-[var(--home-accent)] hover:text-[var(--home-accent)] dark:text-slate-400';
