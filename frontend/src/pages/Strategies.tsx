            ...
            <tbody className="divide-y divide-gray-100">
              {results.map((r) => (
                <tr key={r.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3 font-mono text-blue-600">{r.code}</td>
                  <td className="px-4 py-3">{r.name || '-'}</td>
                  <td className="px-4 py-3 text-gray-500">{r.trade_date}</td>
                  <td className="px-4 py-3 text-right font-mono">{r.score?.toFixed(1) ?? '-'}</td>
                  <td className="px-4 py-3 text-right font-mono">{r.price?.toFixed(2) ?? '-'}</td>
