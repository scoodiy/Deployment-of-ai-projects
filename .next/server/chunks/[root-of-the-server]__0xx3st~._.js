module.exports=[93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},85148,(e,t,r)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},12e3,e=>{"use strict";var t=e.i(85148),r=e.i(14747),a=e.i(49632);let E=r.default.join(process.cwd(),"data","ayuu.db"),s=null;e.s(["getDb",0,function(){return s||((s=new t.default(E)).pragma("journal_mode = WAL"),s.pragma("foreign_keys = ON"),function(e){e.exec(`
  ...
  `).all(r,Number(a));return A.NextResponse.json({comments:E})}async function m(e){let t=await (0,L.getUserFromRequest)(e);if(!t)return A.NextResponse.json({error:"请先登录后评论"},{status:401});try{let{target_type:r,target_id:a,content:E,parent_id:s}=await e.json();if(!r||void 0===a||!E)return A.NextResponse.json({error:"缺少必要参数"},{status:400});if(!["blog","media","music","friend","project"].includes(r))return A.NextResponse.json({error:"无效的 target_type"},{status:400});if("string"!=typeof E||0===E.trim().length)return A.NextResponse.json({error:"评论内容不能为空"},{status:400});if(E.length>2e3)return A.NextResponse.json({error:"评论内容不能超过2000字"},{status:400});let T=(0,I.getDb)().prepare(`
      INSERT INTO comments (user_id, target_type, target_id, content, parent_id, status)
      VALUES (?, ?, ?, ?, ?, 'approved')
    `).run(t.userId,r,Number(a),E.trim(),s||null);return A.NextResponse.json({success:!0,id:T.lastInsertRowid})}catch(e){return console.error("Create comment error:",e),A.NextResponse.json({error:"评论失败"},{status:500})}}e.s(["GET",0,U,"POST",0,m],71673);var g=e.i(71673);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/comments/route",pathname:"/api/comments",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/comments/route.ts",nextConfigOutput:"",userland:g}),{workAsyncStorage:D,workUnitAsyncStorage:O,serverHooks:F}=C;async function h(e,t,a){a.requestMeta&&(0,E.setRequestMeta)(e,a.requestMeta),C.isDev&&(0,E.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let A="/api/comments/route";A=A.replace(/\/index$/,"")||"/";let I=await C.prepare(e,t,{srcPage:A,multiZoneDraftMode:!1});if(!I)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:L,params:U,nextConfig:m,parsedUrl:g,isDraftMode:D,prerenderManifest:O,routerServerContext:F,isOnDemandRevalidate:h,revalidateOnlyGenerated:S,resolvedPathname:x,clientReferenceManifest:M,serverActionsManifest:f}=I,y=(0,i.normalizeAppPath)(A),v=!!(O.dynamicRoutes[y]||O.routes[x]),X=async()=>((null==F?void 0:F.render404)?await F.render404(e,t,g,!1):t.end("This page could not be found"),null);if(v&&!D){let e=!!O.routes[x],t=O.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(m.adapterPath)return await X();throw new R.NoFallbackError}}let b=null;!v||C.isDev||D||(b="/index"===(b=x)?"/":b);let w=!0===C.isDev||!v,P=v&&!w;f&&M&&(0,T.setManifestsSingleton)({page:A,clientReferenceManifest:M,serverActionsManifest:f});let G=e.method||"GET",k=(0,s.getTracer)(),j=k.getActiveScopeSpan(),q=!!(null==F?void 0:F.isWrappedByNextServer),K=!!(0,E.getRequestMeta)(e,"minimalMode"),Y=(0,E.getRequestMeta)(e,"incrementalCache")||await C.getIncrementalCache(e,m,O,K);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let H={params:U,previewProps:O.preview,renderOpts:{experimental:{authInterrupts:!!m.experimental.authInterrupts},cacheComponents:!!m.cacheComponents,supportsDynamicResponse:w,incrementalCache:Y,cacheLifeProfiles:m.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,E)=>C.onRequestError(e,t,a,E,F)},sharedContext:{buildId:L}},B=new n.NodeNextRequest(e),W=new n.NodeNextResponse(t),V=o.NextRequestAdapter.fromNodeNextRequest(B,(0,o.signalFromNodeResponse)(t));try{let E,T=async e=>C.handle(V,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=k.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${G} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),E&&E!==e&&(E.setAttribute("http.route",a),E.updateName(t))}else e.updateName(`${G} ${A}`)}),i=async E=>{var s,i;let n=async({previousCacheEntry:r})=>{try{if(!K&&h&&S&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await T(E);e.fetchMetrics=H.renderOpts.fetchMetrics;let i=H.renderOpts.pendingWaitUntil;i&&a.waitUntil&&(a.waitUntil(i),i=void 0);let n=H.renderOpts.collectedTags;if(!v)return await (0,c.sendResponse)(B,W,s,H.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,l.toNodeOutgoingHttpHeaders)(s.headers);n&&(t[p.NEXT_CACHE_TAGS_HEADER]=n),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=p.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,a=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=p.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:_.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:A,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:h})},!1,F),t}},o=await C.handleResponse({req:e,nextConfig:m,cacheKey:b,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:O,isRoutePPREnabled:!1,isOnDemandRevalidate:h,revalidateOnlyGenerated:S,responseGenerator:n,waitUntil:a.waitUntil,isMinimalMode:K});if(!v)return null;if((null==o||null==(s=o.value)?void 0:s.kind)!==_.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==o||null==(i=o.value)?void 0:i.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",h?"REVALIDATED":o.isMiss?"MISS":o.isStale?"STALE":"HIT"),D&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let d=(0,l.fromNodeOutgoingHttpHeaders)(o.value.headers);return K&&v||d.delete(p.NEXT_CACHE_TAGS_HEADER),!o.cacheControl||t.getHeader("Cache-Control")||d.get("Cache-Control")||d.set("Cache-Control",(0,N.getCacheControlHeader)(o.cacheControl)),await (0,c.sendResponse)(B,W,new Response(o.value.body,{headers:d,status:o.value.status||200})),null};q&&j?await i(j):(E=k.getActiveScopeSpan(),await k.withPropagatedContext(e.headers,()=>k.trace(d.BaseServerSpan.handleRequest,{spanName:`${G} ${A}`,kind:s.SpanKind.SERVER,attributes:{"http.method":G,"http.target":e.url}},i),void 0,!q))}catch(t){if(t instanceof R.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:h})},!1,F),v)throw t;return await (0,c.sendResponse)(B,W,new Response(null,{status:500})),null}}e.s(["handler",0,h,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:D,workUnitAsyncStorage:O})},"routeModule",0,C,"serverHooks",0,F,"workAsyncStorage",0,D,"workUnitAsyncStorage",0,O],28528)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0xx3st~._.js.map