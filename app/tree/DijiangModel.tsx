...
export default function DijiangModel({ posts = [], chatters = [], moments = [] }: DijiangModelProps) {
  ...
  const realWishes: TacticalRecord[] = [];
  ...
  if (!mounted) return <div className="min-h-[80vh] flex items-center justify-center text-slate-500 font-mono tracking-widest bg-transparent"><span className="animate-pulse">INITIALIZING...</span></div>;
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl mx-auto mt-10 mb-16 px-4 relative z-0">
         ...
         <LabComments key={`workshop-comments-${currentMonthStr}`} pageId={`workshop-${currentMonthStr}`} />
      </div>
