...
export async function GET(request: Request) {
  ...
  const db = getDb();
  let query = 'SELECT id, username, email, nickname, avatar, bio, signature, role, status, ban_reason, admin_remark, ai_daily_limit, must_change_password, last_login_at, created_at, updated_at FROM users';
